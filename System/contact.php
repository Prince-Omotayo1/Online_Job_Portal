...
<head>
	...
	<title>Full Jobs - Contact Us</title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images\job.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> 12, <br/> Alayoyo Street, <br/>Isara, Ogun State</address>
								</li>
								<li>
										<h5>Email</h5><a href="quadriigbokoyi@gmail.com">quadriigbokoyi@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+234 907 664 9250">+234 907 664 92504</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Full Jobs</h5>
											<p>Full Jobs is a job portal, online job management system developed for posting jobs and providing jobs.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Full Jobs Contact</h5>
								
								<p>Address : 12, Alayoyo Street, Isara, Ogun State</p>
								<p>Email : <a href="quadriigbokoyi@gmail.com">quadriigbokoyi@gmail.com</a></p>
								<p>Phone : <a href="tel:+2349076649250">+234 907 664 9250</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> I. Quadri O. Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by I. Quadri O.</a></li>
								</ul>
